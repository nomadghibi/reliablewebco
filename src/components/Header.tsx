  ...
  return (
    ...
    >
      <nav className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/audit" className="text-gray-700 hover:text-primary-600 font-medium transition-colors">
              Free Audit
            </Link>
      ...
      {!isMobileMenuOpen && (
        <a
          href="tel:+13219535199"
          className="md:hidden fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-4 z-50 bg-accent-600 text-white p-4 rounded-full shadow-lg hover:bg-accent-700 transition-colors"
          aria-label="Call us"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
