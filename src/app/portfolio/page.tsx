...
export const metadata: Metadata = {
  title: 'Portfolio — Real Websites, Real Results | ReliableWebCo',
  description:
  ...
  return (
    <main className="pt-20">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real feedback from real business owners who grew their business with ReliableWebCo.
            </p>
          </div>
      ...
      <CTASection
        ...
        subtitle="Join the businesses already growing with ReliableWebCo. From landing pages to full platforms, we'll build exactly what you need."
