...
export const metadata: Metadata = {
  title: 'About — ReliableWebCo | Fast, Professional Website Development',
  description:
    'Learn about ReliableWebCo. We build lead-generating websites fast. No agency bloat, no endless timelines — just professional websites that convert.',
};
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-700 mb-6">
                ReliableWebCo (operated by Best Computer Tech LLC) specializes in building high-converting websites for local service businesses.
              </p>
